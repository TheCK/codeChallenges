...
@Solution(id=82, name="Armstrong Numbers", description="Determine if a number is an armstrong number.", url="https://www.codeeval.com/open_challenges/82/", category="Easy callenges")
public class Main
{

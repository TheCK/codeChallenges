...
@Solution(id = 59, name = "Telephone Words", description = "Print out the words corresponding to a telephone number", url = "https://www.codeeval.com/open_challenges/59/", category = "Hard callenges")
public class Main
{

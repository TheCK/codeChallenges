...
@Solution(id = 52, name = "Text Dollar", description = "Print out the text dollar amount of a given quantity", url = "https://www.codeeval.com/open_challenges/52/", category = "Hard callenges")
public class Main
{

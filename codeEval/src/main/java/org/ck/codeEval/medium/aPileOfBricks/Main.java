...
public class Main
{
		...
		try (BufferedReader buffer = new BufferedReader(new FileReader(file)))
		{
			...
			while ((line = buffer.readLine()) != null)
			{
				...
				for(String brickDef : brickDefs)
				{
					...
					Dimension d1 = new Dimension(brickCoord1[0], brickCoord1[1], brickCoord2[0], brickCoord2[1]);
					Dimension d2 = new Dimension(brickCoord1[0], brickCoord1[2], brickCoord2[0], brickCoord2[2]);
					Dimension d3 = new Dimension(brickCoord1[1], brickCoord1[2], brickCoord2[1], brickCoord2[2]);
	...
	private static class Dimension
	{
		...
		{
			if ((this.dX >= otherDimension.dX && this.dY >= otherDimension.dY) || (this.dX >= otherDimension.dY && this.dY >= otherDimension.dX))
			{
				return true;
			}

...
@Solution(id = 236, name = "Beat or bit", description = "Learn more about the Gray code algorithm.", url = "https://www.codeeval.com/open_challenges/236/", category = "Moderate challenges")
public class Main
{

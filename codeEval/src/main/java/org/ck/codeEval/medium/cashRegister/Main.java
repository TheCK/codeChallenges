...
@Solution(id = 54, name = "Cash Register", description = "Determine the amount of change to be returned", url = "https://www.codeeval.com/open_challenges/54/", category = "Moderate callenges")
public class Main
{

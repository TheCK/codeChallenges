...
@Solution(id = 73, name = "Decode Numbers", description = "Count the number of ways to decode a string.", url = "https://www.codeeval.com/open_challenges/73/", category = "Moderate callenges")
public class Main
{

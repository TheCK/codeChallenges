...
@Solution(id = 78, name = "Sudoku", description = "Determine if a grid layout is a valid sudoku solution.", url = "https://www.codeeval.com/open_challenges/78/", category = "Moderate challenges")
public class Main
{

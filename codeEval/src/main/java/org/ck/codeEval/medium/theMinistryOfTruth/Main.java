...
@Solution(id = 143, name = "The Ministry of Truth", description = "Your task is to help the Big Brother", url = "https://www.codeeval.com/open_challenges/143/", category = "Moderate callenges")
public class Main
{

...
@Solution(id = 192, name = "Compare Points", description = "Given two (x, y) points A and B, determine which cardinal direction B is from A.", url = "https://www.codeeval.com/open_challenges/192/", category = "Easy challenges")
public class Main
{

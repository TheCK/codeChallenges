...
@Solution(id = 189, name = "Minimum Distance", description = "Find a point with the smallest sum of distances to every given point.", url = "https://www.codeeval.com/open_challenges/189/", category = "Easy challenges")
public class Main
{

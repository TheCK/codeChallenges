...
@Solution(id = 216, name = "Everything or nothing", description = "Check if a code is correct.", url = "https://www.codeeval.com/open_challenges/216/", category = "Hard challenges")
public class Main
{
	...
	private enum Permission
	{
		BAN
				{
					@Override public Permission grant(String permission)
					{
						switch(permission)
						{
							case "grant":
					...
					@Override public boolean isAllowed(String action)
					{
						return false;
					}
				},

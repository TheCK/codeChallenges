...
@Solution(
    ...
    description = "Print out the words corresponding to a telephone number",
    url = "https://www.codeeval.com/open_challenges/59/",
...
public class Main {
  ...
  private static void printFirst(
      StringBuilder builder, String original, String current, String sofar) {

...
@Solution(id = 162, name = "Too unique", description = "Find and mark the biggest submatrices of unique elements.", url = "https://www.codeeval.com/open_challenges/162/", category = "Hard challenges")
public class Main
{

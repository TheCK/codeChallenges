...
@Solution(id = 223, name = "Alternative reality", description = "Count all alternative ways.", url = "https://www.codeeval.com/open_challenges/223/", category = "Moderate challenges")
public class Main
{

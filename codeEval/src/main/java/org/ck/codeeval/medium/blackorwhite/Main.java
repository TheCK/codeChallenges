...
@Solution(
    id = 209,
    name = "Black or white",
    description = "Find the smallest submatrix",
    url = "https://www.codeeval.com/open_challenges/209/",
  ...
  public static void main(String[] args) throws Exception {
    ...
    try (BufferedReader buffer = new BufferedReader(new FileReader(file))) {
      ...
      while ((line = buffer.readLine()) != null) {
        ...
        System.out.println(
            String.format("%dx%d, %d", smallestSize, smallestSize, blackCarsInSmallestMatrix));
      }
    }
  }

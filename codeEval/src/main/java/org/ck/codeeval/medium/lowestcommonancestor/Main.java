...
@Solution(
    ...
    description = "Determine the lowest common ancestor within a tree",
    url = "https://www.codeeval.com/open_challenges/11/",
  ...
  public static void main(String[] args) throws Exception {
    ...
    try (BufferedReader buffer = new BufferedReader(new FileReader(file))) {
      ...
      while ((line = buffer.readLine()) != null) {
        ...
        System.out.println(
            values.get(new Point(Integer.parseInt(numbers[0]), Integer.parseInt(numbers[1]))));
      }
    }
  }
}

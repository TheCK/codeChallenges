...
@Solution(
    ...
    description = "Determine if it is possible to produce the number 42 with five cards.",
    url = "https://www.codeeval.com/open_challenges/190/",
...
public class Main {
  ...
  private static void getPermutations(
      List<List<Integer>> permutations, List<Integer> remainingNumbers, List<Integer> current) {

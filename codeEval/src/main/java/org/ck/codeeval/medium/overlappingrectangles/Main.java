  ...
  public static void main(String[] args) throws Exception {
    ...
    try (BufferedReader buffer = new BufferedReader(new FileReader(file))) {
      ...
      while ((line = buffer.readLine()) != null) {
        ...
        if (topLeftX1 <= topLeftX2
            && topLeftX2 <= lowerRightX1
            && lowerRightY1 <= topLeftY2
            && topLeftY2 <= topLeftY1) {
          intersects = true;
        }
        if (topLeftX1 <= topLeftX2
            && topLeftX2 <= lowerRightX1
            && lowerRightY1 <= lowerRightY2
            && lowerRightY2 <= topLeftY1) {
          intersects = true;
        }
        if (topLeftX1 <= lowerRightX2
            && lowerRightX2 <= lowerRightX1
            && lowerRightY1 <= lowerRightY2
            && lowerRightY2 <= topLeftY1) {
          intersects = true;
        }
        ...
        if (topLeftX2 <= topLeftX1
            && topLeftX1 <= lowerRightX2
            && lowerRightY2 <= topLeftY1
            && topLeftY1 <= topLeftY2) {
          intersects = true;
        }
        if (topLeftX2 <= topLeftX1
            && topLeftX1 <= lowerRightX2
            && lowerRightY2 <= lowerRightY1
            && lowerRightY1 <= topLeftY2) {
          intersects = true;
        }
        if (topLeftX2 <= lowerRightX1
            && lowerRightX1 <= lowerRightX2
            && lowerRightY2 <= lowerRightY1
            && lowerRightY1 <= topLeftY2) {
          intersects = true;
        }

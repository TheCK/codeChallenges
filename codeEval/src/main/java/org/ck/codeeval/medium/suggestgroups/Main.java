...
@Solution(
    id = 165,
    name = "Suggest Groups",
    description = "Help your friends to join groups.",
      ...
      while ((line = buffer.readLine()) != null) {
        ...
        if (arguments.length == 3) {
          people.put(
              arguments[0],
              (new Main())
              .new Person(arguments[0], arguments[1].split(","), arguments[2].split(",")));
        } else if (arguments.length == 2) {
          people.put(
              arguments[0], (new Main()).new Person(arguments[0], arguments[1].split(","), null));
        }
      }

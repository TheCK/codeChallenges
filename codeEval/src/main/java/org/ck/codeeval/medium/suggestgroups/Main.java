...
@Solution(id = 165, name = "Suggest Groups", description = "Help your friends to join groups.", url = "https://www.codeeval.com/open_challenges/165/", category = "Moderate challenges")
public class Main
{

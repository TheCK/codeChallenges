...
@Solution(id = 81, name = "Sum to Zero", description = "Count of ways in which the sum of four numbers is zero", url = "https://www.codeeval.com/open_challenges/81/", category = "Moderate challenges")
public class Main
{

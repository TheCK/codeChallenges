...
public class MainTest extends BaseTest
{
	...
	public void test00() throws Exception
	{
		...
		assertEquals(getResult("Tom exhibited.",
				"Amy Lawrence was proud and glad, and... <Read More>",
				"Tom was tugging at a button-hole and looking sheepish.",
				"Two thousand verses is a great many -... <Read More>",
				"Tom's mouth watered for the apple, but... <Read More>"), this.output.toString());
	}
	...
	public void test01() throws Exception
	{
		...
		assertEquals(getResult("123456789A123456789B123456789C123456789D... <Read More>",
				...
				"Every face his name.",
				"I can't himself.",
				"You think of guile, and went on his... <Read More>"), this.output.toString());
	}
}

...
public class SolutionTest {
  private static Solution.ListNode toLinkedList(final int[] numbers) {
    final Solution.ListNode root = new Solution.ListNode(numbers[0]);
  ...
  void test(final Solution.ListNode l1, final Solution.ListNode l2, final int[] expected)
      throws Exception {
